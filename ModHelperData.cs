...
public static class ModHelperData
{
    ...
    public const string Description =
        ...
        New: In Game Charts: Damage Meters and Bloons Round Display, Ability Cooldown Seconds Display, Rogue Legends Hotkeys, Jukebox Folder, Quick Sell, Multi Place, UI Transparency, Hotkey Display, Wiki Links, Clear Alerts, Full Screen Hotkey, Tower Selection Hotkeys, Cursor Size Hotkeys, Keep Default Upgrade Sounds
